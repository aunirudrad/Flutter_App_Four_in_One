        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              ProjectCard(
                title:
                    'A machine learning approach towards thyroid disease prediction',
                description:
                    'A ML-based project to identify thyroid diseases by machine learning techniques.',
              ),
              ProjectCard(
                title: 'AI Tutor',
                description:
                    'Development of a web-based AI Tutor that can be converted into a talking humanoid robot, aimed at enhancing interactive learning.',
              ),
              ProjectCard(
                title: 'IoT Home Automation',
                description:
                    'An IoT project utilizing Arduino to automate home appliances and enhance security through sensors and smart technology.',
              ),
              SizedBox(height: 24),
              ...
              ListTile(
                ...
                title: Text('anu15-4170@diu.edu.bd'),
              ),
              ListTile(
                leading: Icon(Icons.phone),
                title: Text('+8801311107482'),
              ),
              ListTile(
