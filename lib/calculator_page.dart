        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              ...
              Row(
                children: <Widget>[
                  _buildScientificButton('sin', Colors.white, () => _numClick('sin(')),
                  _buildScientificButton('cos', Colors.white, () => _numClick('cos(')),
                  _buildScientificButton('tan', Colors.white, () => _numClick('tan(')),
